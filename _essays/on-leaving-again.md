...
![gas_station]({{ '/assets/images/IMG_7067.jpeg' | relative_url }})
*Bisbee, Arizona. 2025.*

I keep a camera in the passenger seat, but half the time I don’t use it. Some moments feel truer when they pass unrecorded. The point isn’t proof, it’s presence.

The in-between is uncomfortable, but it’s also where everything loosens—the armor, the performance, the need to appear “busy.” It’s where I remember why I started doing this work at all: to pay attention. To stand in the dust and listen for whatever’s still alive under the noise.

I guess that’s the real job. Everything else is just logistics.
